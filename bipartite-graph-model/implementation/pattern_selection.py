import os
import numpy as np
from pattern_selection_utils import get_input_and_output_patterns, get_threshold, get_valid_inputs_and_outputs, get_output_statistics, plot_signal_statistics
from constants import BASE_PATH

def main():

    # Read the input matrix from CSV file
    initial_weights = np.loadtxt(os.path.join(BASE_PATH, 'data\original_data\Inputs_normal_dis.csv'), delimiter=',')
